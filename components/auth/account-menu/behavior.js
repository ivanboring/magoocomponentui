/**
 * Account menu — opens/closes the dropdown, closes on outside click or Escape.
 */
export default function init(root, props) {
  const toggle = root.querySelector(".account-menu__toggle");
  const menu = root.querySelector(".account-menu__menu");
