...
Reviewed on 2026-07-14 at https://ivanboring.github.io/magoocomponentui/c/onboarding/upgrade-prompt. The rendered component was opened in a browser at a 375 x 812 viewport; its available controls were hovered, focused, and safely clicked.
...
The current prop surface (title, description, used, limit, pct, ...) can remain the simple default while supporting these opt-in extensions:
