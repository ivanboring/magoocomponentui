...
Reviewed on 2026-07-14 at https://ivanboring.github.io/magoocomponentui/c/onboarding/success-state. The rendered component was opened in a browser at a 375 x 812 viewport; its available controls were hovered, focused, and safely clicked.
...
The current prop surface (title, description, summary, primary_label, secondary_label) can remain the simple default while supporting these opt-in extensions:
